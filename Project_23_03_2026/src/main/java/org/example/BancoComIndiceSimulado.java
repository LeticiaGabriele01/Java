...
public class BancoComIndiceSimulado {
    ...
    private void carregarTabela(){
        ...
        tabela.put(205, new Cliente(205, "Bruno", "Matão"));
        tabela.put(310, new Cliente(310, "Carla", "Ribeirão Preto"));
        tabela.put(450, new Cliente(450, "Diego", "São Carlos"));
        tabela.put(520, new Cliente(520,"Elisa", "Campinas"));
        tabela.put(610, new Cliente(610, "Fabio", "Franca"));
    }
    ...
    public Cliente buscaClientePorId(int idBuscado){
        ...
        if (encontrado){
            System.out.println("ID encontrado no Indice. Buscando registro na tabela ...");
